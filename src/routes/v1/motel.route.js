...
router
  .route('/')
  .post(auth(), validate(motelValidation.postMotel), motelController.postMotel)
...
router.route('/user/:userId')
  .get(auth(), validate(motelValidation.getMotelsByUserId), motelController.getMotelsByUserId)
